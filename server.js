...
const { register, requestMetricsMiddleware, dbQueryDuration } = require('./metrics/custom');
...
app.listen(PORT, (err) => {
    ...
    logger.info(`Server is running in ${process.env.NODE_ENV} on http://localhost:${PORT}`);
});
